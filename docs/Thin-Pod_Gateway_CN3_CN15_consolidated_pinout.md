...
**Out of scope:** The Thin-Pod node section from the source note is intentionally ignored for now.
...
|---|---|---:|---|---|
| SPI SCK | CN14 D13 | **CN15 pin 11** | PE15 / SPI5_SCK | J10 pin 23, SPI1_CLK |
| SPI MISO | CN14 D12 | **CN15 pin 13** | PG1 / SPI5_MISO | J10 pin 21, SPI1_MISO |
| SPI MOSI | CN14 D11 | **CN15 pin 15** | PG2 / SPI5_MOSI | J10 pin 19, SPI1_MOSI |
| DWM CS | CN14 D10 | **CN15 pin 17** | PA3 | J10 pin 24, CS_RPI |
| DWM IRQ | CN15 pin 16 | **CN15 pin 16** | PB9 | J10 pin 15, GPIO_RPI |
...
|---|---:|---|
| 5V_DWM | **CN3 pin 6** | DWM3001C-CDK J10 pin 2 or J10 pin 4 |
| GND_DWM | **CN3 pin 8** | DWM3001C-CDK J10 pin 6 |
...
|---|---|---:|---|---|
| SPI CLK | CN14 D13 | **CN15 pin 11** | PE15 / SPI5_SCK | XIAO SCK |
| SPI MISO | CN14 D12 | **CN15 pin 13** | PG1 / SPI5_MISO | XIAO MISO |
| SPI MOSI | CN14 D11 | **CN15 pin 15** | PG2 / SPI5_MOSI | XIAO MOSI |
...
| Net | Preferred NUCLEO pin | Destination |
|---|---:|---|
| 3V3_C6 | **CN3 pin 16** | XIAO 3V3 |
| GND_C6 | **CN3 pin 20** | XIAO GND |
| C6_EN_RST | **CN3 pin 17** | XIAO EN/RST |
...
|---|---:|---|---|---|
| SPI5_SCK | **CN15.11** | PE15 | DWM J10.23 SPI1_CLK | XIAO SCK |
| SPI5_MISO | **CN15.13** | PG1 | DWM J10.21 SPI1_MISO | XIAO MISO |
| SPI5_MOSI | **CN15.15** | PG2 | DWM J10.19 SPI1_MOSI | XIAO MOSI |
| DWM_CS | **CN15.17** | PA3 | DWM J10.24 CS_RPI | - |
| DWM_IRQ | **CN15.16** | PB9 | DWM J10.15 GPIO_RPI | - |
| DWM_RESET | **CN15.33** | PD0 | DWM J10.12 RESET | - |
| C6_CS | **CN15.19** | PD7 | - | XIAO CS |
| C6_INT | **CN15.5** | PC1 | - | XIAO INT |
| C6_EN_RST | **CN3.17** | PC0 | - | XIAO EN/RST |
| 5V_DWM | **CN3.6** | 5V rail | DWM J10.2 or J10.4 | - |
| 3V3_C6 | **CN3.16** | 3V3 rail | - | XIAO 3V3 |
...
|---|---|
| CN14 D13 / PE15 / SPI5_SCK | **CN15 pin 11 / PE15 / SPI5_SCK** |
| CN14 D12 / PG1 / SPI5_MISO | **CN15 pin 13 / PG1 / SPI5_MISO** |
| CN14 D11 / PG2 / SPI5_MOSI | **CN15 pin 15 / PG2 / SPI5_MOSI** |
...
CN15.11  PE15 / SPI5_SCK   ----+--> DWM3001C-CDK J10.23 SPI1_CLK
                               +--> XIAO ESP32-C6 SCK

CN15.13  PG1 / SPI5_MISO   <---+--  DWM3001C-CDK J10.21 SPI1_MISO
                               +--  XIAO ESP32-C6 MISO

CN15.15  PG2 / SPI5_MOSI   ----+--> DWM3001C-CDK J10.19 SPI1_MOSI
                               +--> XIAO ESP32-C6 MOSI

CN15.17  PA3 / DWM_CS      -------> DWM3001C-CDK J10.24 CS_RPI
CN15.16  PB9 / DWM_IRQ     <------- DWM3001C-CDK J10.15 GPIO_RPI
CN15.33  PD0 / DWM_RESET   -------> DWM3001C-CDK J10.12 RESET

CN15.19  PD7 / C6_CS       -------> XIAO ESP32-C6 CS
CN15.5   PC1 / C6_INT      <------- XIAO ESP32-C6 INT
...
CN3.17   PC0 / C6_EN_RST   -------> XIAO ESP32-C6 EN/RST
...
|---|---|---:|
| DWM3001C-CDK | DWM_CS | CN15 pin 17 / PA3 |
| XIAO ESP32-C6 | C6_CS | CN15 pin 19 / PD7 |
...
Keep **DWM_RESET on PD0 via CN15 pin 33**, not on **CN3 pin 14 / NRST**. CN3 pin 14 is the NUCLEO reset net. Using it would couple the DWM reset to the NUCLEO's own reset behaviour rather than giving the STM32 firmware a clean independent reset output.
