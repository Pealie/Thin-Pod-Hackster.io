...
* SCK: CN14 **D13** (PE15 / SPI5_SCK) → CDK J10 **23** (SPI1_CLK) 
* MISO: CN14 **D12** (PG1 / SPI5_MISO) → CDK J10 **21** (SPI1_MISO) 
* MOSI: CN14 **D11** (PG2 / SPI5_MOSI) → CDK J10 **19** (SPI1_MOSI) 

Control

* CS: CN14 **D10** (PA3) → CDK J10 **24** (CS_RPI) 
* IRQ: **CN15 pin 16 = PB9** → CDK J10 **15** (GPIO_RPI) 
